...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border border-zinc-800/80 bg-zinc-900/70 text-zinc-100 shadow-xl backdrop-blur-md transition-all duration-200",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-base font-semibold leading-none tracking-tight text-zinc-100 flex items-center justify-between",
      className
    )}
    {...props}
  />
